    ...
    <div class="bg-white p-8 rounded-lg shadow-md w-full">
        ...
        <div class="mt-4 bg-gray-100 p-2">
            ...
            <div class="py-2">
                ...
                {{-- Delete Applicant --}}
                <form action="{{ route('applicant.destroy', $applicant->id) }}" method="POST" onsubmit="return confirm('Are you sure to delete this applicant')">
                    @csrf
                    @method('DELETE')
        ...
        @empty
        <p class="text-gray-700">You have no job listing</p>
        @endforelse
    </div>
    </section>
    <x-bottom-banner />
